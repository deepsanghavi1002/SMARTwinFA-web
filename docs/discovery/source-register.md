...
| SRC-PROC-001 | `postgres-procedures_validated.sql` and `mssql-all-sp-script.sql` received 2026-08-21 | Confidential business logic | SHA-256, sizes, source/target name coverage, missing routines, and residual conversion markers recorded in `docs/intake/postgres-procedures-2026-08-21/analysis.json` | Quarantined; 282 PostgreSQL declarations are not compile/parity validated and 46 detected source names are missing |
